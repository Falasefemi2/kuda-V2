      ...
      <div className="flex justify-between items-center w-full max-w-[1500px] mx-auto md:pl-[60px] md:pr-[60px] px-[14px] md:px-[20px]">
        ...
        <div className="flex items-center ml-auto">
          <Link
            ...
            className="text-[0.875rem] w-full max-w-full font-bold text-primary-color hidden md:inline"
          >
            Sign In
          </Link>
          <Link
            href="/joinkuda"
            className="h-[43px] text-sm min-w-[136px] max-w-[136px] ml-10 font-bold leading-[1] items-center justify-center p-[15px] bg-primary-color text-white rounded-lg transition duration-600 transform hover:-translate-y-1 hover:scale-110 hidden md:flex"
          >
            Join Kuda
          </Link>
            ...
            <div className="flex items-center text-primary-color h-10 cursor-pointer">
              <div className="ml-[7px] flex">
                <Image
                  ...
                  height={100}
                  width={100}
                  className="h-8 w-8 md:h-auto md:w-32"
                  alt="world"
                />
              </div>
            </div>
