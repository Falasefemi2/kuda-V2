...
const Testing = () => {
  ...
  return (
    <div className="fixed w-full left-0 top-0 z-[99] bg-white h-[65px]  box-shadow flex items-center justify-between">
      <div className="flex justify-between items-center w-full max-w-[1500px] mx-auto md:pl-[60px] md:pr-[60px] px-[14px] md:px-[20px]">
        ...
        <div className="flex items-center ml-auto">
          <Link href='https://app.kuda.com' className="text-[0.875rem] w-full max-w-full font-bold text-primary-color">
          Sign In
          </Link>
          <Link href='/joinkuda' className="h-[43px] text-sm min-w-[136px] max-w-[136px] ml-10 font-bold leading-[1] flex items-center justify-center p-[15px] bg-primary-color text-white rounded-lg transition duration-600 transform hover:-translate-y-1 hover:scale-110">
          Join Kuda
          </Link>
